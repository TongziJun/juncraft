...
export default defineConfig({
  base: '/',
  title: "JUNCRAFT官方网站",
  description: "欢迎来到JUNCRAFT，在这里你可以查阅服务条款，游戏教程与服务器各类信息，希望能对你有所帮助！",
  themeConfig: {
    // https://vitepress.dev/reference/default-theme-config
    nav: [
      { text: '首页', link: '/' },
      { text: '玩家举报', link: 'https://docs.qq.com/form/page/DR1FOUE5FUmRUY0Ju' },
      { text: '游戏规则', link: '/tos' },
      { text: '游玩教程', link: '/java' },
      { text: '社区公告', link: '/notice' },
      { text: '人机客服', link: 'https://ima.qq.com/wiki/?shareId=182c8ca87cf91034012f9b39e01cf7582a5585d1e60a169a0b51dfc3de88137b' },
      { text: '获取日志', link: 'https://www.123684.com/s/mYsLVv-rJdI' },
      { text: '卫星地图', link: 'http://110.42.44.172:27006/' }
    ],
